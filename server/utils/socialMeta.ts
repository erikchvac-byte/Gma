...
//
// og:image is the branded wide banner served at /og-image.png (2400x1260, the
// 1200x630 spec at @2x), so the card type is `summary_large_image`.
...
const OG_IMAGE_ALT = "Gmas List — is it worth the drive?"
