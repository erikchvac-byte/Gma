...
// as a separate process (FastAPI on :8000, Playwright + GraphQL interception) and
// is the only way to read Dutchie/iFrame menus, which are invisible to Axios+Cheerio.
...
const SERVICE_URL = 'http://localhost:8000/scrape'
